-- Migración simplificada para el sistema de agentes
-- Sin problemas de ON CONFLICT

-- 1. Actualizar el perfil del usuario para que sea agente
...
-- 2. Asignar todas las propiedades existentes a este usuario
UPDATE public.properties 
SET user_id = 'e2c5466f-fb05-4a2c-a9c7-01ad767ed6c3'
WHERE user_id IS NULL;

-- 3. Crear tabla para estadísticas de propiedades
DROP TABLE IF EXISTS public.property_statistics;
...
-- 4. Habilitar RLS para property_statistics
ALTER TABLE public.property_statistics ENABLE ROW LEVEL SECURITY;

-- 5. Políticas para property_statistics
...
-- 6. Función simplificada para actualizar estadísticas
...
BEGIN
  ...
  IF TG_TABLE_NAME = 'property_views' THEN
    -- Insertar o actualizar estadísticas de vistas
...
-- 7. Crear triggers para actualizar estadísticas automáticamente
...
-- 8. Inicializar estadísticas para propiedades existentes
