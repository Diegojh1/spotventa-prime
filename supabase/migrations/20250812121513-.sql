-- Fix the constraint definitions - they were backwards
...
ALTER TABLE public.properties ADD CONSTRAINT properties_property_type_check CHECK (property_type IN ('apartment', 'house', 'office', 'land', 'commercial', 'studio', 'penthouse'));

-- Insert sample properties with correct values
